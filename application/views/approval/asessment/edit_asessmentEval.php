<div class="container-fluid text-center">
	...
	<div class="container align-content-start">
		<form id="editForm" action="<?= base_url('Approval/editAsessment'); ?>" method="post" enctype="multipart/form-data" class="row gy-2 gx-3 mb-3">
	...
	<script>
		$(document).ready(function() {
			$('#editForm').on('change', 'select[data-field]', function() {
				updatePredictions();
			});
		...
		function save() {
			...
			$.ajax({
				type: 'POST',
				url: '<?= base_url('Approval/editAsessment'); ?>', // Adjust the URL to your controller endpoint
				data: formData,
