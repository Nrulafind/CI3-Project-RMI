<div class="container-fluid text-center">
	...
	<div class="container align-content-start">
		<form id="myForm" action="<?= base_url('Approval/saveUmum'); ?>" method="post" enctype="multipart/form-data" class="row gy-2 gx-3 mb-3">
	...
	<script>
		...
		function save() {
			...
			$.ajax({
				type: 'POST',
				url: '<?= base_url('Approval/saveUmum'); ?>', // Adjust the URL to your controller endpoint
				data: formData,
		...
		function updatePredictions() {
			...
			$.ajax({
				type: 'POST',
				url: '<?= base_url("proyeksi_"); ?>', // Use form action
				data: formData,
				dataType: 'json',
